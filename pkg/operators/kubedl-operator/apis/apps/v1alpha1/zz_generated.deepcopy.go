...
func (in *Schedule) DeepCopyInto(out *Schedule) {
	*out = *in
	if in.MaxReplicaPerNode != nil {
		in, out := &in.MaxReplicaPerNode, &out.MaxReplicaPerNode
		*out = new(int32)
		**out = **in
	}
	if in.ResourcesRanges != nil {
		in, out := &in.ResourcesRanges, &out.ResourcesRanges
		*out = make([]ResourcesRange, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
